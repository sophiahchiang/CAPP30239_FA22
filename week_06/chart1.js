// let count_race = function(input) {
//     let count = new Map();
//     for (d in input) {
//         let race = d.Race;
//         if (count.has(race)) {
//             count.set(race,count.get(race)+1);
//         }
//         else {
//             count.set(race,1)
//         }
...
d3.json('a3cleanedonly2015.json').then(data => {
    ...
    genderraces = races.flatMap(race => data.map(d=> ({data: d.FIELD1, Gender, Race: d[race]})))
    ...
    let chart = StackedBarChart(data, {
        ...
        y: d => d.genderraces, 
        z: d => d.Gender,
        xDomain: d3.groupSort(data, D => d3.sum(D, d => d.Race), d => d.Race),
        yLabel: "↑ Population (millions)",
        zDomain: data.Gender,
        colors: d3.schemeSpectral[data.Gender],
        width: 1000,
        height: 500
      });
