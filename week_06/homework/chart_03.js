...
d3.json('a3cleanedonly2015.json').then(data => {
    ...
    // for (let d of data) {
    //     if (d.Gender === "Male") {
    //         genderdata[0].Totals += 1; // newData[0] is Male (line 6)
    //     } else if (d.Gender === "Female") {
    //         genderdata[1].Totals += 1; // newData[1] is Female (line 10)
    //     } else {
    //         genderdata[2].Totals += 1; // newData[2] is Other (line 14)
    //     }
    // };
